...
Begin VB.Form frm_ORDERS_NOT_PENDING 
   Caption         =   "Orders Not Pending"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_ORDERS_NOT_PENDING"
...
On Error GoTo errHandler
    ...
    Set rec = cls_ORDER_Obj.fn_LOAD_ORDERS_REPORT(lngID)
