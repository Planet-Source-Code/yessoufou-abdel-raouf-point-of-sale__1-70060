...
Begin VB.Form frm_DELIVERY_REP 
   ...
   End
End
Attribute VB_Name = "frm_DELIVERY_REP"
...
On Error GoTo errHandler
    ...
    Set rec = cls_DELIVERY_Obj.fn_LOAD_DELIVERY_REPORT(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Deliveries_Rep.rpt")
