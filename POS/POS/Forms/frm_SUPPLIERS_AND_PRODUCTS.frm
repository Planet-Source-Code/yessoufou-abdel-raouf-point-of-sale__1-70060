...
Begin VB.Form frm_SUPPLIERS_AND_PRODUCTS 
   Caption         =   "SUPPLIERS & PRODUCTS"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_SUPPLIERS_AND_PRODUCTS"
...
On Error GoTo errHandler
    ...
    Set rec = cls_SUPPLIER_Obj.fn_LOAD_SUPPLIERS_REPORT(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Suppliers_And_Products_Rep.rpt")
