...
Begin VB.Form frm_STOCK_CUMULATIVE_REP 
   Caption         =   "STOCK CUMULATIVE REPORT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_STOCK_CUMULATIVE_REP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub sub_LOAD_REPORT()
On Error GoTo errHandler
    ...
    Set rec = cls_CATEGORY_Obj.fn_LOAD_STOCK_CUMULATIVE_REP()
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Stock_Cumulative_Rep.rpt")
