...
Begin VB.Form frm_EXPENDITURES_REPPORT 
   Caption         =   "EXPENDITURES REPORT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_EXPENDITURES_REPPORT"
...
On Error GoTo errHandler
    ...
    Set rec = cls_EXPENDITURES_Obj.fN_LOAD_EXPENDITURES_REPORT(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Expenditures_Rep.rpt")
