...
Begin VB.Form frm_CUSTOMERS_REPORT 
   ...
   End
End
Attribute VB_Name = "frm_CUSTOMERS_REPORT"
...
On Error GoTo errHandler
    ...
    Set rec = cls_CUSTOMER_Obj.fn_LOAD_CUSTOMERS_REPORT(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Customers_Rep.rpt")
