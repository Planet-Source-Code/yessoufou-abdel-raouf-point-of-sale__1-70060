...
Begin VB.Form frm_PENDING_ORDERS_REP 
   Caption         =   "PENDING ORDERS REPORT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_PENDING_ORDERS_REP"
...
On Error GoTo errHandler
    ...
    Set rec = cls_ORDER_Obj.fn_LOAD_PENDING_ORDERS_REPORT
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Orders_Rep.rpt")
