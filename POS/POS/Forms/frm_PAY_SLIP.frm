...
Begin VB.Form frm_PAY_SLIP 
   ...
   End
End
Attribute VB_Name = "frm_PAY_SLIP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public Sub sub_LOAD_REPORT(lngID As Long)
On Error GoTo errHandler
    ...
    Set rec = cls_SALARIES_Obj.fn_LOAD_SALARIES(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\PaySlip_Rep.rpt")
