...
Begin VB.Form frm_SALES_REP 
   ...
   End
End
Attribute VB_Name = "frm_SALES_REP"
...
On Error GoTo errHandler
    ...
    Set rec = cls_SALES_Obj.fn_LOAD_SALES_REPORT(lngID, DTPFrom, DTPTo)
    
    If rec.AbsolutePosition = -1 Then
        MsgBox "No Sales Have Been Made So Far", vbInformation, Title
        
        Else
        
        Dim myApp As New CRAXDRT.Application
        Dim myAppReport As CRAXDRT.Report
        Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Sales_Rep.rpt")
