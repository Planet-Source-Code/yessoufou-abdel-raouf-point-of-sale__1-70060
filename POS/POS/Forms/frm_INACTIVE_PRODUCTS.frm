...
Begin VB.Form frm_INACTIVE_PRODUCTS 
   Caption         =   "INACTIVE PRODUCTS REPORT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frm_INACTIVE_PRODUCTS"
...
On Error GoTo errHandler
    ...
    Set rec = cls_CATEGORY_Obj.fN_LOAD_INACTIVE_PRODUCTS_REPORT(lngID)
    
    Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Categories_Products_Rep.rpt")
