...
Begin VB.Form frm_DELIVERY_TAX_REP 
   Caption         =   "PURCHASE TAX REPORT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin OCX.b8Container b8Container1 
      ...
      Begin lvButton.lvButtons_H cmdLoad 
         ...
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frm_DELIVERY_TAX_REP.frx":0000
      End
   ...
   End
End
Attribute VB_Name = "frm_DELIVERY_TAX_REP"
...
On Error GoTo errHandler
    ...
    Set rec = cls_DELIVERY_Obj.fn_LOAD_DELIVERY_TAX_REPORT(lngID, DTPFrom, DTPTo)
    
    If rec.AbsolutePosition = -1 Then
        MsgBox "No Deliveries Have Been Made So Far", vbInformation, Title
        
        Else
        
        Dim myApp As New CRAXDRT.Application
        Dim myAppReport As CRAXDRT.Report
        Set myAppReport = myApp.OpenReport(App.Path & "\Reports\Purchase_Tax.rpt")
